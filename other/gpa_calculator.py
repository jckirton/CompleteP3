def gpa_calc(*grades: {"Description": "Letter grade input/inputs.", "Accepted Datatypes": ["Multiple string inputs", "List containing strings", "One string"]}, do_print: {"Description": "Whether or not to print the results.", "Accepted Datatypes": bool}):
    letter_to_number = {
        "A": 5,
        "B": 4,
        "C": 3,
